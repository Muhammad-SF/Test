...
class PurchaseReport(models.Model):
    ...
    exchange_product_qty = fields.Float("Product Exchange")
        ...
        select_str = """
            WITH currency_rate as (%s)
                SELECT
                    ...
                    s.state,
                    l.shipment_days as shipment_days,
                    s.date_approve,
                    s.dest_address_id,
                    ...
                    mrl.product_id as return_product_id,
                    sum(mrl.product_uom_qty/u.factor*u2.factor) as exchange_product_qty,
    ...
    def _from(self):
        from_str = """
                purchase_order_line l
                    ...
                    left join manual_return_line mrl on (l.product_id=mrl.product_id)
