...
class SalaryAdvancePayment(models.Model):
    ...
    date = fields.Date(string='Date', required=True, default=lambda self: fields.Date.today(), track_visibility='onchange')
    ...
    advance = fields.Float(string='Advance', required=True, track_visibility='onchange')
    payment_method = fields.Many2one('account.journal', string='Payment Method', track_visibility='onchange')
    ...
    debit = fields.Many2one('account.account', string='Debit Account', track_visibility='onchange')
    credit = fields.Many2one('account.account', string='Credit Account', track_visibility='onchange')
    journal = fields.Many2one('account.journal', string='Journal', track_visibility='onchange')
    employee_contract_id = fields.Many2one('hr.contract', string='Contract', track_visibility='onchange')
