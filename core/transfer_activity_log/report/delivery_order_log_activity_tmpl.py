...
class ReportDeliveryLogActivity(models.AbstractModel):
    _name = 'report.transfer_activity_log.delivery_log_activity_report'
    ...
    def render_html(self, docids, data=None):
        ...
        report = report_obj._get_report_from_name('transfer_activity_log.delivery_log_activity_report')
        ...
        return report_obj.render('transfer_activity_log.delivery_log_activity_report', docargs)
