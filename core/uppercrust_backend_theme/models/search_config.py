...
class GlobalSearchConfig(models.Model):
    ...
    field_ids = fields.Many2many('ir.model.fields', string='Fields', domain="[('model_id', '=', model_id), ('name', '!=', 'id'), ('ttype', '!=', 'boolean'), ('selectable', '=', True)]", required="1", order="ir_model_fields_id.field_description desc")
