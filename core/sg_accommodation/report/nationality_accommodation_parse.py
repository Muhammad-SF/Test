...
class nationality_accommodation(models.AbstractModel):
    _name = 'report.sg_accommodation.view_nationality_report'
    ...
    def render_html(self, docids, data=None):
        report = self.env['report']._get_report_from_name('sg_accommodation.view_nationality_report')
        ...
        return self.env['report'].render('sg_accommodation.view_nationality_report', docargs)
