...
class SaleReport(models.Model):
    ...
    sh_sec_uom = fields.Many2one("product.uom", "Secondary UOM", readonly=True)
    sh_sec_qty = fields.Float("Secondary Qty")

    def _select(self):
        return super(SaleReport, self)._select() + ", l.sh_sec_uom as sh_sec_uom" + ",l.sh_sec_qty as sh_sec_qty"

    def _group_by(self):
        return super(SaleReport, self)._group_by() + ", l.sh_sec_uom" + ",l.sh_sec_qty"
        ...
        self._cr.execute("""
            create view purchase_report as (
                ...
                select
                    ...
                    sum(l.sh_sec_qty/u.factor*u2.factor) as sh_sec_qty,
