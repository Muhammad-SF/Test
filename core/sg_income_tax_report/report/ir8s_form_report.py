    ...
    def get_data(self, form):
        ...
        for contract in contract_rec:
            ...
            for contract_income_tax in income_tax_rec:
                ...
                emp_designation = ''
                pay_user_brw = self.env['res.users'].browse(int(form.get('payroll_user')))
                ...
                for income_tax_rec in contract_income_tax:
                    ...
                    res['march_gross_amt'] = formatLang(self.env, march_gross_amt)
                    res['apr_gross_amt'] = formatLang(self.env, apr_gross_amt)
                    res['may_gross_amt'] = formatLang(self.env, may_gross_amt)
                    res['june_gross_amt'] = formatLang(self.env, june_gross_amt)
                    res['july_gross_amt'] = formatLang(self.env, july_gross_amt)
                    res['aug_gross_amt'] = formatLang(self.env, aug_gross_amt)
                    res['sept_gross_amt'] = formatLang(self.env, sept_gross_amt)
                    ...
                    res['jan_empoyee_amt'] = formatLang(self.env, jan_empoyee_amt)
                    res['feb_empoyee_amt'] = formatLang(self.env, feb_empoyee_amt)
                    res['march_empoyee_amt'] = formatLang(self.env, march_empoyee_amt)
                    res['apr_empoyee_amt'] = formatLang(self.env, apr_empoyee_amt)
                    res['may_empoyee_amt'] = formatLang(self.env, may_empoyee_amt)
                    res['june_empoyee_amt'] = formatLang(self.env, june_empoyee_amt)
                    res['july_empoyee_amt'] = formatLang(self.env, july_empoyee_amt)
                    res['aug_empoyee_amt'] = formatLang(self.env, aug_empoyee_amt)
                    res['sept_empoyee_amt'] = formatLang(self.env, sept_empoyee_amt)
                    res['oct_empoyee_amt'] = formatLang(self.env, oct_empoyee_amt)
                    res['nov_empoyee_amt'] = formatLang(self.env, nov_empoyee_amt)
                    res['dec_empoyee_amt'] = formatLang(self.env, dec_empoyee_amt)

                    res['jan_empoyer_amt'] = formatLang(self.env, jan_empoyer_amt)
                    res['feb_empoyer_amt'] = formatLang(self.env, feb_empoyer_amt)
                    res['march_empoyer_amt'] = formatLang(self.env, march_empoyer_amt)
                    res['apr_empoyer_amt'] = formatLang(self.env, apr_empoyer_amt)
                    res['may_empoyer_amt'] = formatLang(self.env, may_empoyer_amt)
                    res['june_empoyer_amt'] = formatLang(self.env, june_empoyer_amt)
                    res['july_empoyer_amt'] = formatLang(self.env, july_empoyer_amt)
                    res['aug_empoyer_amt'] = formatLang(self.env, aug_empoyer_amt)
                    res['sept_empoyer_amt'] = formatLang(self.env, sept_empoyer_amt)
                    res['oct_empoyer_amt'] = formatLang(self.env, oct_empoyer_amt)
                    res['nov_empoyer_amt'] = formatLang(self.env, nov_empoyer_amt)
                    res['dec_empoyer_amt'] = formatLang(self.env, dec_empoyer_amt)
