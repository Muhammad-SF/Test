...
#        worksheet.insert_bitmap(path,0,2,1)
        ...
        for id in ids:
            worksheet.write_merge(0, 0, 3, 5, id.company_id.name, header)
...
#                   CURRENT YEAR
                    ...
                    if total_leave != 0:
                        worksheet.write(row, col + 7, int(total_leave) , table_border1_center)
                    else:
...
#                   BALANCE YTD
                    if total_leave  != 0:
                        if taken_leave and taken_leave[0] and taken_leave[0] != None:
                            ...
                            worksheet.write(row, col + 10, after_blc or 0, table_border1_center)
                        else:
                            worksheet.write(row, col + 10, total_leave , table_border1_center)
                    else:
