...
class sg_leave_contract(models.Model):
    ...
    holiday_group_config_line_ids = fields.One2many('holiday.group.config.line','holiday_group_config_id','Config Line', copy=True)
...
class holiday_group_config_line(models.Model):
    ...
    default_leave_allocation = fields.Float('Default Leave Days')
    ...
    carryover_expired_day = fields.Integer('Carryover Expired Days')
    enable_carryover_exp = fields.Boolean('Enable Carryover Exp')
