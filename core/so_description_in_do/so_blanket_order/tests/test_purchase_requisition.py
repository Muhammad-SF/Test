...
class TestPurchaseRequisition(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.requisition1 = self.env['purchase.requisition'].create({'line_ids': [(0, 0, {'product_id': self.product_09_id, 'product_uom_qty': 10.0, 'product_uom_id': self.product_09_uom_id})]})
    ...
    def test_02_purchase_requisition(self):
        ...
        for procurement in procurements:
            ...
            self.assertEqual(float_compare(line.product_uom_qty, procurement.product_uom_qty, precision_digits=2), 0, "Quantity is not correspond.")
