   ...
   // 'mouseout   .task-gantt-item, .task-gantt-timeline-row'     :'handleHoverOut',
    ...
    start: function(){
        ...
        if (!this.record.is_group) {
            ...
            if(this.record["wo_state"] == 'done'){
                color_gantt = 'rgba(98, 196, 51, 0.38)'
            }
            if(this.record['wo_state'] == 'ready' || this.record['wo_state'] == 'progress'){
            ...
            //Possition
            var get_possition = false
            if(this.record["wo_state"] == 'done'){
                get_possition = this.get_position(this.record.effective_dt_st, this.record.effective_dt_ed, this.record.date_deadline);
            }
            if(this.record['wo_state'] == 'pending' || this.record['wo_state'] == 'ready' || this.record['wo_state'] == 'progress'){
                get_possition = this.get_position(this.record.planed_dt_st, this.record.planed_dt_ed, this.record.date_deadline);
            }
            if(this.record["wo_state"] == undefined){
                get_possition = this.get_position(this.record.task_start, this.record.task_stop, this.record.date_deadline);
            }
    ...
    BarSave: function(r_id, type){
        ...
        if (type === "bar"){
            ...
            if (check_readonly){
                ...
                return parent.do_search(parent.last_domains, parent.last_contexts, parent.last_group_bys, parent.options);
            }
